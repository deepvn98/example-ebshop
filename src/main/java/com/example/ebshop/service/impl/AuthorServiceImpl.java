...
import com.example.ebshop.dto.response.AuthorResponse;
...
public class AuthorServiceImpl implements AuthorService {
    ...
    public ResponseData getInformationAuthor(String isbn) {
        ...
        if (authorInData == null) {
            ...
            authorResponse.setIsbn(authorInData.getIsbn());
            authorResponse.setName(authorInData.getName());
            authorResponse.setBookList(list);
            authorResponse.setQuantityBook(bookList.size());
            responseData.setHttpStatus(HttpStatus.OK);
            responseData.setMessage("SUCCESS!");
            responseData.setObject(authorResponse);
            responseData.setCode("200");
        }
